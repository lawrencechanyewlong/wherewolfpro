Feature: Reading location of sharer on browser
  
    As a receiver
    So that I can track the location of the sharer easily
    I want to be able to read the location of the sharer
